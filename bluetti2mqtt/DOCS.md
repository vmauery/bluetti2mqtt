...
This is a simple Home Assistant add-on for [bluetti_mqtt](https://github.com/vmauery/bluetti_mqtt).

This add-on was created as an easy method to get Bluetti data into Home Assistant, without having to setup [bluetti_mqtt](https://github.com/vmauery/bluetti_mqtt) on a separate device.
...
> - `discovery` - Used for reverse engineering, see [here](https://github.com/vmauery/bluetti_mqtt#reverse-engineering).

> - `logger` - Used for reverse engineering, see [here](https://github.com/vmauery/bluetti_mqtt#reverse-engineering).
...
> What fields to configure in Home Assistant - defaults to most fields ("normal"), see [here](https://github.com/vmauery/bluetti_mqtt#home-assistant-integration).
...
- Github repository: [bluetti_mqtt](https://github.com/vmauery/bluetti_mqtt)
